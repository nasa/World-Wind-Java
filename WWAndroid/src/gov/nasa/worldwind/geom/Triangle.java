...
public class Triangle
{
    ...
    protected final Vec4 a = new Vec4();
    protected final Vec4 b = new Vec4();
    protected final Vec4 c = new Vec4();
     ...
     * @param indices      the indices forming the tri-fan.
     * @param triangleType the type of triangle collection, either GLES20.GL_TRIANGLES, GLES20.GL_TRIANGLE_STRIP or
    ...
    public static List<Intersection> intersectTriangleTypes(final Line line, FloatBuffer vertices, IntBuffer indices,
        int triangleType)
    {
        if (triangleType == GLES20.GL_TRIANGLES)
            return Triangle.intersectTriangles(line, vertices, indices);
        else if (triangleType == GLES20.GL_TRIANGLE_STRIP)
            return Triangle.intersectTriFan(line, vertices, indices);
        else if (triangleType == GLES20.GL_TRIANGLE_FAN)
            return Triangle.intersectTriFan(line, vertices, indices);
