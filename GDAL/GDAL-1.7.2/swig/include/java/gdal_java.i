...
{
    public void load(String libName) throws java.lang.UnsatisfiedLinkError;
}

private static class gdalLibraryLoader implements LibraryLoader
{
    public void load(String libraryNameOrPath) throws java.lang.UnsatisfiedLinkError
    {
        System.loadLibrary(libraryNameOrPath);
    }
}

    private static LibraryLoader loader = new gdalLibraryLoader();

    public static void setLibraryLoader(LibraryLoader newLoader)
    {
        if (null != newLoader)
            loader = newLoader;
    }
    ...
    public static void loadLibrary(String libName) throws java.lang.UnsatisfiedLinkError
    {
        if (null != loader)
            loader.load(libName);
    }
...
class ProgressCallback
{
    ...
    int run(double dfComplete, const char*pszMessage)
    {
        return 1;
    }
};
